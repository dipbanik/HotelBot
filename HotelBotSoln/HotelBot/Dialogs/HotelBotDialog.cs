...
namespace HotelBot.Dialogs
{
    public class HotelBotDialog
    {
        public static readonly IDialog<string> dialog = Chain.PostToChain()
            ...
            {
                return Chain.ContinueWith(new GreetingDialogs(), AfterGreetingContinuation);
            }),
        ...
        public async static Task<IDialog<string>> AfterGreetingContinuation(IBotContext context, IAwaitable<object> item)
        {
